...
export default function Form({ video }) {
   const [editVideo,{data:editedVideo,isError,isLoading,isSuccess,error}] = useEditVideoMutation();
    const {
        id,
        title: initialTitle,
            ...
            <div className="shadow overflow-hidden sm:rounded-md">
                ...
                <div className="grid grid-cols-6 gap-6">
                        <div className="col-span-6 sm:col-span-3">
                            <TextInput title="title" value={title} onChange={(e)=> setTitle(e.target.value)}  />
                        </div>
